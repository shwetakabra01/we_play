...
import 'home_nav_copy_model.dart';
export 'home_nav_copy_model.dart';

class HomeNavCopyWidget extends StatefulWidget {
  const HomeNavCopyWidget({super.key});

  @override
  State<HomeNavCopyWidget> createState() => _HomeNavCopyWidgetState();
}

class _HomeNavCopyWidgetState extends State<HomeNavCopyWidget> {
  late HomeNavCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeNavCopyModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<VenueRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<VenueRecord> homeNavCopyVenueRecordList = snapshot.data!;
