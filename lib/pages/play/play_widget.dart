                      ...
                      children: [
                        Padding(
                          ...
                          child: FlutterFlowDropDown<String>(
                            controller:
                                _model.filterEventsDdValueController1 ??=
                                    FormFieldController<String>(
                              _model.filterEventsDdValue1 ??=
                                  widget.filterEvents,
                            ),
                            options: [
                              'Upcoming Games',
                            ...
                            onChanged: (val) => setState(
                                () => _model.filterEventsDdValue1 = val),
                                                                ...
                                                                Padding(
                                                                  ...
                                                                  child: Text(
                                                                    dateTimeFormat(
                                                                        'MMMEd',
                                                                        functions
                                                                            .parseDate(eventsWoRecsItem.date)),
                                                                    style: FlutterFlowTheme.of(
                                                                            context)
                                                                        .bodyMedium
                                                                        .override(
                                                                  ...
                                                                  _model.eventsForRef =
                                                                    ...
                                                                    queryBuilder: (eventsRecord) =>
                                                                        eventsRecord
                                                                            .where(
                                                                              'status',
                                                                              isEqualTo: eventsWoRecsItem.status,
                                                                            )
                                                                            .where(
                                                                              'name',
                                                                              isEqualTo: eventsWoRecsItem.name,
                                                                            )
                                                                            .where(
                                                                              'date',
