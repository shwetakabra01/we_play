  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> adminUsersRecordList = snapshot.data!;
                                                ...
                                                children: [
                                                  Expanded(
                                                    child: FlutterFlowDropDown<
                                                        String>(
                                                      controller: _model
                                                              .ddlTeam1ValueController ??=
                                                          FormFieldController<
                                                              String>(
                                                        _model.ddlTeam1Value ??=
                                                            '',
                                                      ),
                                                      options: List<
                                                              String>.from(
                                                ...
                                                children: [
                                                  Expanded(
                                                    child: FlutterFlowDropDown<
                                                        String>(
                                                      controller: _model
                                                              .ddlTeam2ValueController ??=
                                                          FormFieldController<
                                                              String>(
                                                        _model.ddlTeam2Value ??=
                                                            '',
                                                      ),
                                                      options: List<
                                                              String>.from(
                                                  ...
                                                  onPressed: () async {
                                                    await TeamEventsRecord
                                                        ...
                                                        .set(
                                                          ...
                                                          team1: containerTeamsRecordList
                                                              .where((e) =>
                                                                  e.reference
                                                                      .id ==
                                                                  _model
                                                              ...
                                                              .first
                                                              .reference,
                                                          team2: containerTeamsRecordList
                                                              .where((e) =>
                                                                  e.reference
                                                                      .id ==
                                                                  _model
