...
import 'update_team_model.dart';
export 'update_team_model.dart';

class UpdateTeamWidget extends StatefulWidget {
  const UpdateTeamWidget({
    super.key,
    this.pageTitle,
    required this.team,
  });
  ...
  @override
  State<UpdateTeamWidget> createState() => _UpdateTeamWidgetState();
}

class _UpdateTeamWidgetState extends State<UpdateTeamWidget> {
  late UpdateTeamModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdateTeamModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      setState(() {
        _model.selectedMembers =
            widget.team!.members.toList().cast<TeamMemberStruct>();
      });
    });
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> updateTeamUsersRecordList = snapshot.data!;
          ...
          child: Scaffold(
            ...
            body: SafeArea(
              ...
              child: Column(
                ...
                children: [
                  if (widget.pageTitle == 'Add Member')
                    Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  if (!widget.team!.memberRefs.contains(
                                      updateTeamUsersRecordList
                                          .where((e) =>
                                              e.uid == _model.userDdValue)
                                          .toList()
                                          .first
                                          .reference)) {
                                    await widget.team!.reference.update({
                                      ...mapToFirestore(
                                        {
                                          'memberRefs': FieldValue.arrayUnion([
                                            updateTeamUsersRecordList
                                                .where((e) =>
                                                    e.uid == _model.userDdValue)
                                                .toList()
                                    ...
                                    await showDialog(
                                      ...
                                      builder: (alertDialogContext) {
                                        return AlertDialog(
                                          ...
                                          content: Text(
                                              'Member already present in team.'),
                                          actions: [
                                            TextButton(
                                              onPressed: () => Navigator.pop(
                                                  alertDialogContext),
                                ...
                                text: 'Add to Team ${widget.team?.name}',
                                options: FFButtonOptions(
                                  width: MediaQuery.sizeOf(context).width * 1.0,
                                  height: 40.0,
                                  padding: EdgeInsetsDirectional.fromSTEB(
                  ...
                  if (widget.pageTitle == 'Edit Team Stats')
                    Container(
                      width: MediaQuery.sizeOf(context).width * 1.0,
                      decoration: BoxDecoration(
                        color: FlutterFlowTheme.of(context).secondaryBackground,
                  ...
                  if (widget.pageTitle == 'Upload Media')
                    Container(
                      width: MediaQuery.sizeOf(context).width * 1.0,
                      decoration: BoxDecoration(
                        color: FlutterFlowTheme.of(context).secondaryBackground,
                  ...
                  if (widget.pageTitle == 'Remove Member')
                    Expanded(
                      child: Container(
                        width: MediaQuery.sizeOf(context).width * 1.0,
                        decoration: BoxDecoration(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                        ...
                                        ...mapToFirestore(
                                          {
                                            ...
                                            'memberRefs': _model.selectedMembers
                                                .map((e) => e.memberRef)
                                                .withoutNulls
                                                .toList(),
                                          },
                                    ...
                                    text: 'Remove From ${widget.team?.name}',
                                    options: FFButtonOptions(
                                      width: MediaQuery.sizeOf(context).width *
                                          1.0,
                                      height: 40.0,
