            ...
            children: [
              ...
              Expanded(
                child: Container(
                  ...
                  child: StreamBuilder<List<VenueRecord>>(
                      ...
                      return ListView.separated(
                        ...
                        itemBuilder: (context, listViewIndex) {
                          final listViewVenueRecord =
                              listViewVenueRecordList[listViewIndex];
                          return Visibility(
                            visible: (_model.textController.text == null ||
                                    _model.textController.text == '') ||
                                ((String searchTxt, String vName) {
                                  return vName.indexOf(searchTxt) >= 0;
                                }(_model.textController.text,
                                    listViewVenueRecord.name)),
                            child: Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            CarouselPhotosWidget(
                                              key: Key(
                                                  'Keyx7t_${listViewIndex}_of_${listViewVenueRecordList.length}'),
                                              parameter1:
                                                  listViewVenueRecord.photos,
                                            ),
                                            Container(
                                              width: 170.0,
                                              height: 150.0,
                                          ...
                                          builder: (context) {
                                            ...
                                            return Row(
                                              ...
                                              children: List.generate(
                                                  ...
                                                  (availableOffersIndex) {
                                                final availableOffersItem =
                                                    availableOffers[
                                                        availableOffersIndex];
                                                return Padding(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        ...
                        image: Image.asset(
                          'assets/images/Coming-Soon-Venue-short.jpg',
                        ).image,
                      ),
                    ),
