...
export 'onboarding_views_model.dart';

class OnboardingViewsWidget extends StatefulWidget {
  const OnboardingViewsWidget({
    super.key,
    this.mobileNumber,
  });
  ...
  @override
  State<OnboardingViewsWidget> createState() => _OnboardingViewsWidgetState();
}

class _OnboardingViewsWidgetState extends State<OnboardingViewsWidget> {
  late OnboardingViewsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OnboardingViewsModel());
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Uniting Players, One Game at a Time',
                              style: FlutterFlowTheme.of(context)
                                  .titleSmall
                                  .override(
                                    fontFamily: 'Roboto',
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 0.0, 0.0, 20.0),
                                  child: Text(
                                    'Your mobile number will be used to login into WePlay.',
                                    style: FlutterFlowTheme.of(context)
                                        .titleSmall
                                        .override(
                                          fontFamily: 'Roboto',
